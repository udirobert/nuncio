...
typography:
  ...
  # — display ramp (Instrument Serif 400, sentence case, negative tracking. Real italic face ships in assets/fonts/ for the pull-quote register.) —
  headline:{ fontFamily: "Instrument Serif", cqw: 4.6, weight: 400, lineHeight: 1.06, tracking: "-0.018em" }
  quote-pull:{ fontFamily: "Instrument Serif", cqw: 5.0, weight: 400, lineHeight: 1.12, tracking: "-0.012em", italic: true }
  display-italic:{ fontFamily: "Instrument Serif", cqw: 6.7, weight: 400, lineHeight: 1.05, tracking: "-0.012em", italic: true }
  display:{ fontFamily: "Instrument Serif", cqw: 7.3, weight: 400, lineHeight: 1.02, tracking: "-0.022em" }
  number-hero:{ fontFamily: "Instrument Serif", cqw: 9.4, weight: 400, lineHeight: 0.95, tracking: "-0.025em" }
  display-cover:{ fontFamily: "Instrument Serif", cqw: 9.9, weight: 400, lineHeight: 0.98, tracking: "-0.028em" }
  number-unit:{ fontFamily: "Geist Mono", cqw: 2.08, weight: 500, lineHeight: 1.0 }

font-face:
  # Deterministic, offline @font-face. Ship these four woff2 in assets/fonts/ and
  # register exactly this block in every composition <style> (self-hosted, no CDN).
