  ...
  return (
    ...
    >
      ...
      <LiveTwinPanel
        ...
        mode={mode}
        liveTwinEnabled={liveTwinEnabled}
        onToggle={() => setLiveTwinEnabled(!liveTwinEnabled)}
        creditBalance={creditBalance}
        trainingCreditCost={trainingCreditCost}
        anamAvatarStatus={anamAvatarStatus}
        anamVoiceStatus={anamVoiceStatus}
